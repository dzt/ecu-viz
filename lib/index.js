...
lib.createConnectors = function(input) {
    ...
    let buildArr = [
        ...
        (input.idle_valve != null) ? connector.create(input.idle_valve, "stepper_valve_options") : null, /* Stepper Valve connector if applicable */
...
lib.createCables = function(summary, input) {
    ...
    let cableObj = utils.builder([
        ...
        (input.idle_valve != null) ? cables.createIdleValveConnection(_.findWhere(summary.auxiliary_outputs, { type: 'stepper_valve_options' }), ecuID) : null, /* Stepper Valve connector if applicable */
