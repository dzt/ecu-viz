...
class Cables {
    ...
    createChassisConnections () {
        ...
        let auxiliary_outputs = this.context.summary.auxiliary_outputs; 
    ...
    createCANConnection (canConnector) {
    ...
    createFlexConnection (digitalInputs) {
    ...
    createIdleValveConnection (idleConnector) {
